...
ComPtr<ID3D12RootSignature>ColliderSphereObject::rootsignature;
ComPtr<ID3D12PipelineState>ColliderSphereObject::pipelinestate;
...
void ColliderSphereObject::Update()
{
...
void ColliderSphereObject::Move()
{
}

void ColliderSphereObject::Draw(ID3D12GraphicsCommandList* cmdList)
{
	//モデルの割り当てがなければ描画市内
	if (model == nullptr)
	{
...
void ColliderSphereObject::CreateGraphicsPipeline()
{
