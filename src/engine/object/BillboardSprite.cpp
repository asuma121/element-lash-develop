...
void BillboardSprite::UpdateBillboard()
{
...
void BillboardSprite::Move()
{
}

void BillboardSprite::Draw(ID3D12GraphicsCommandList* cmdList)
{
	//モデルの割り当てがなければ描画市内
	if (model == nullptr)
	{
...
void BillboardSprite::CreateGraphicsPipeline()
{
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/BillboardSprite/BillboardSpriteVertexShader.hlsl",     // シェーダファイル名
		nullptr,
	...
	// ピクセルシェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/BillboardSprite/BillboardSpritePixelShader.hlsl",   // シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
