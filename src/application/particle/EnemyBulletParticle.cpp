/**
 * @file EnemyBulletParticle.cpp
 * @brief ゲームオブジェクト 敵の弾のパーティクル
 * @author Asuma Syota
 * @date 2023/4
 */
...
SrvManager* EnemyBulletParticle::srvManager = nullptr;
...
void EnemyBulletParticle::CreateGraphicsPipeline()
{
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/EnemyBulletParticle/EnemyBulletParticleVertexShader.hlsl",     // シェーダファイル名
		nullptr,
	...
	// 頂点シェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/EnemyBulletParticle/EnemyBulletParticleGeometryShader.hlsl",     // シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
	...
	// ピクセルシェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/EnemyBulletParticle/EnemyBulletParticlePixelShader.hlsl",   // シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
...
void EnemyBulletParticle::CreateBuffers()
{
	HRESULT result;
...
void EnemyBulletParticle::Update()
{
	//-----この上に頂点の更新処理を書く-----
...
void EnemyBulletParticle::UpdateParticle()
{
	//寿命が尽きたパーティクルを全削除
...
void EnemyBulletParticle::Draw(ID3D12GraphicsCommandList* cmdList)
{
	//パイプラインステートの設定
...
void EnemyBulletParticle::Add(XMFLOAT3 pos)
{
	float randPos = 10.0f;
	float randVelo = 0.2f;
...
void EnemyBulletParticle::AddParticle(int life, XMFLOAT3 position, XMFLOAT3 velocity, XMFLOAT3 accel, float startScale, float endScale)
{
	//リストに要素を追加
