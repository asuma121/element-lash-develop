...
public:	//静的メンバ関数
	...
	///デバイスセット
	/// </summary>
	static void SetDevice(ID3D12Device* device) { EnemyBulletParticle::device = device; }

	/// <summary>
	///カメラセット
	/// </summary>
	static void SetCamera(Camera* camera) { EnemyBulletParticle::camera = camera; }
