...
void ExplosionParticle1::CreateGraphicsPipeline()
{
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/ExplosionParticle1/ExplosionParticle1VertexShader.hlsl",     // シェーダファイル名
		nullptr,
	...
	// 頂点シェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/ExplosionParticle1/ExplosionParticle1GeometryShader.hlsl",     // シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
	...
	// ピクセルシェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/ExplosionParticle1/ExplosionParticle1PixelShader.hlsl",   // シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
...
void ExplosionParticle1::CreateBuffers()
{
	HRESULT result;
...
void ExplosionParticle1::Update()
{
	//-----この上に頂点の更新処理を書く-----
...
void ExplosionParticle1::UpdateParticle()
{
	//寿命が尽きたパーティクルを全削除
...
void ExplosionParticle1::Draw(ID3D12GraphicsCommandList* cmdList)
{
	//パイプラインステートの設定
...
void ExplosionParticle1::Add(XMFLOAT3 pos)
{
	float randPos = 5.0f;
...
void ExplosionParticle1::AddParticle(int life, XMFLOAT3 position, XMFLOAT3 velocity, XMFLOAT3 accel, float startScale, float endScale)
{
	//リストに要素を追加
